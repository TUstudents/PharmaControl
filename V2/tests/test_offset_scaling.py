...
class TestOffsetScaling:
    ...
    def test_offset_scaling_vs_value_scaling_difference(self, controller, test_scalers):
        ...
        d50_scaler = test_scalers[
            "d50"
        ]  # Range 300-600, so 400 should give (400-300)/(600-300) = 100/300 = 0.333
        lod_scaler = test_scalers[
            "lod"
        ]  # Range 0.5-3.0, so 1.5 should give (1.5-0.5)/(3.0-0.5) = 1.0/2.5 = 0.4
