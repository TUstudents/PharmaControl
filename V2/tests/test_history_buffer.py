...
class TestDataBuffer:
    ...
    def test_model_inputs_retrieval(self):
        ...
        for i in range(5):
            ...
            buffer.add_control_action(np.array([130.0 + i, 550.0 + i*10, 30.0 + i]), time.time() + i)
    ...
    def test_thread_safety(self):
        ...
        buffer = DataBuffer(cma_features=2, cpp_features=3, buffer_size=100, validate_sequence=False)
...
class TestRobustMPCWithRealHistory:
    ...
    def test_controller_initialization_with_buffer(self, mock_model, mock_estimator, test_config, test_scalers):
    ...
    def test_history_buffer_updates_during_control(self, mock_model, mock_estimator, test_config, test_scalers):
    ...
    def test_transition_from_startup_to_real_history(self, mock_model, mock_estimator, test_config, test_scalers):
    ...
    def test_realistic_trajectory_tracking(self, mock_model, mock_estimator, test_config, test_scalers):
