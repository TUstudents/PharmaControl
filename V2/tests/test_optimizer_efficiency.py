...
class TestOptimizerEfficiency:
    ...
    def test_optimizer_instance_creation(self, mock_model, mock_estimator, test_config, test_scalers):
        ...
        assert len(controller.optimizer.param_bounds) == test_config['horizon'] * len(test_config['cpp_names'])
        
    def test_optimizer_reuse_across_steps(self, mock_model, mock_estimator, test_config, test_scalers):
    ...
    def test_fitness_function_injection(self, mock_model, mock_estimator, test_config, test_scalers):
    ...
    def test_backward_compatibility_with_none_optimizer(self, mock_model, mock_estimator, test_config, test_scalers):
